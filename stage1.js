...
const pattern_test_dispatch = (k,pat,v)=>((k==="wildcard-pattern")?"true":((k==="variable-pattern")?"true":((k==="literal-pattern")?_fl_str("(",v,"===",literal_to_js(_fl_get(pat,"type"),_fl_get(pat,"value")),")"):((k==="or-pattern")?or_pattern_test(_fl_get(pat,"patterns"),v,0,""):((k==="range-pattern")?_fl_str("(",v,">=",_fl_get(pat,"min"),"&&",v,"<=",_fl_get(pat,"max"),")"):(true?"false":null))))));;
...
const pattern_bindings_dispatch = (k,pat,v)=>((k==="variable-pattern")?_fl_str("let ",js_name(_fl_get(pat,"name")),"=",v,";"):(true?"":null));;
