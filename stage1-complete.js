...
exports.RUNTIME_HELPERS = void 0;
exports._fl_null_q = _fl_null_q;
exports._fl_true_q = _fl_true_q;
exports._fl_false_q = _fl_false_q;
exports._fl_number_q = _fl_number_q;
exports._fl_string_q = _fl_string_q;
exports._fl_list_q = _fl_list_q;
exports._fl_map_q = _fl_map_q;
exports._fl_fn_q = _fl_fn_q;
exports._fl_length = _fl_length;
exports._fl_first = _fl_first;
exports._fl_last = _fl_last;
exports._fl_rest = _fl_rest;
exports._fl_append = _fl_append;
exports._fl_get = _fl_get;
exports._fl_map_set = _fl_map_set;
exports._fl_keys = _fl_keys;
exports._fl_str = _fl_str;
exports._fl_lower = _fl_lower;
exports._fl_upper = _fl_upper;
exports._fl_trim = _fl_trim;
exports._fl_contains_q = _fl_contains_q;
exports._fl_is_alpha_q = _fl_is_alpha_q;
exports._fl_is_digit_q = _fl_is_digit_q;
exports._fl_is_alnum_q = _fl_is_alnum_q;
exports._fl_is_space_q = _fl_is_space_q;
exports._fl_is_symbol_char_q = _fl_is_symbol_char_q;
exports._fl_map = _fl_map;
exports._fl_filter = _fl_filter;
exports._fl_reduce = _fl_reduce;
exports._fl_empty_q = _fl_empty_q;
exports._fl_has_key_q = _fl_has_key_q;
exports._fl_print = _fl_print;
exports._fl_array_q = _fl_array_q;
exports._fl_request = _fl_request;
exports._fl_response = _fl_response;
exports._fl_wait_and_respond = _fl_wait_and_respond;
// ─────────────────────────────────────────────────────
// 카테고리 1: 타입 체크 (8개)
// ─────────────────────────────────────────────────────
...
function _fl_true_q(v) {
    return v === true;
}
function _fl_false_q(v) {
    return v === false;
}
function _fl_number_q(v) {
    return typeof v === 'number';
}
function _fl_string_q(v) {
    return typeof v === 'string';
}
function _fl_list_q(v) {
    return Array.isArray(v);
}
function _fl_map_q(v) {
...
function _fl_first(arr) {
    return Array.isArray(arr) ? arr[0] : null;
}
function _fl_last(arr) {
    return Array.isArray(arr) ? arr[arr.length - 1] : null;
}
function _fl_rest(arr) {
    return Array.isArray(arr) ? arr.slice(1) : [];
}
function _fl_append(arr, item) {
    return Array.isArray(arr) ? __spreadArray(__spreadArray([], arr, true), [item], false) : [item];
}
function _fl_get(obj, key, defaultVal) {
    var _a, _b;
    if (Array.isArray(obj) && typeof key === 'number') {
        return (_b = (_a = obj[key]) !== null && _a !== void 0 ? _a : defaultVal) !== null && _b !== void 0 ? _b : null;
    }
    if (typeof obj === 'object' && obj !== null) {
        var result = obj[String(key)];
        return result !== undefined ? result : (defaultVal !== null && defaultVal !== void 0 ? defaultVal : null);
    }
    return defaultVal !== null && defaultVal !== void 0 ? defaultVal : null;
}
function _fl_map_set(obj, key, value) {
    var _a;
    return __assign(__assign({}, obj), (_a = {}, _a[String(key)] = value, _a));
}
function _fl_keys(obj) {
    if (typeof obj === 'object' && obj !== null) {
...
function _fl_lower(s) {
    return String(s).toLowerCase();
}
function _fl_upper(s) {
    return String(s).toUpperCase();
}
function _fl_trim(s) {
    return String(s).trim();
}
function _fl_contains_q(s, substr) {
    return String(s).includes(String(substr));
}
// ─────────────────────────────────────────────────────
// 카테고리 4: 문자 분류 (5개)
// ─────────────────────────────────────────────────────
function _fl_is_alpha_q(c) {
    var ch = String(c)[0];
    return /[a-zA-Z]/.test(ch);
}
function _fl_is_digit_q(c) {
    var ch = String(c)[0];
    return /[0-9]/.test(ch);
}
function _fl_is_alnum_q(c) {
    var ch = String(c)[0];
    return /[a-zA-Z0-9]/.test(ch);
}
function _fl_is_space_q(c) {
    var ch = String(c)[0];
    return /\s/.test(ch);
}
function _fl_is_symbol_char_q(c) {
    var ch = String(c)[0];
    return /[!@#$%^&*\-_+=]/.test(ch);
}
// ─────────────────────────────────────────────────────
// 카테고리 5: 고차 함수 (3개)
// ─────────────────────────────────────────────────────
function _fl_map(fn, arr) {
    return arr.map(function (item) { return fn([item]); });
}
function _fl_filter(arr, fn) {
    return arr.filter(function (item) {
        var result = fn([item]);
        return result !== false && result !== null;
    });
}
function _fl_reduce(fn, init, arr) {
    return arr.reduce(function (acc, item) { return fn([acc, item]); }, init);
}
// ─────────────────────────────────────────────────────
// 카테고리 6: 조건부 로직 (2개)
// ─────────────────────────────────────────────────────
function _fl_empty_q(v) {
    if (v === null || v === undefined)
        return true;
    if (Array.isArray(v))
        return v.length === 0;
...
function _fl_has_key_q(obj, key) {
    if (typeof obj === 'object' && obj !== null) {
...
// 카테고리 7: I/O (2개)
// ─────────────────────────────────────────────────────
function _fl_print(msg) {
    console.log(msg);
    return msg;
}
function _fl_array_q(v) {
    return Array.isArray(v);
}
// ─────────────────────────────────────────────────────
// 카테고리 8: HTTP (2개) — 자체호스팅용 스텁
// ─────────────────────────────────────────────────────
function _fl_request(obj) {
    // HTTP 요청 처리 (서버 모드용 스텁)
    return { status: 200, body: '{}', error: null };
}
function _fl_response(obj) {
...
// 카테고리 9: 기타 (1개)
// ─────────────────────────────────────────────────────
function _fl_wait_and_respond(fn, timeout) {
    // 비동기 작업 (현재 동기로 처리)
    return fn([]);
}
// ─────────────────────────────────────────────────────
// 헬퍼 맵 (codegen 주입용)
// ─────────────────────────────────────────────────────
exports.RUNTIME_HELPERS = {
    _fl_null_q: _fl_null_q,
    _fl_true_q: _fl_true_q,
    _fl_false_q: _fl_false_q,
    _fl_number_q: _fl_number_q,
    _fl_string_q: _fl_string_q,
    _fl_list_q: _fl_list_q,
    _fl_map_q: _fl_map_q,
    _fl_fn_q: _fl_fn_q,
    _fl_length: _fl_length,
    _fl_first: _fl_first,
    _fl_last: _fl_last,
    _fl_rest: _fl_rest,
    _fl_append: _fl_append,
    _fl_get: _fl_get,
    _fl_map_set: _fl_map_set,
    _fl_keys: _fl_keys,
    _fl_str: _fl_str,
    _fl_lower: _fl_lower,
    _fl_upper: _fl_upper,
    ...
    _fl_map: _fl_map,
    _fl_filter: _fl_filter,
    _fl_reduce: _fl_reduce,
    _fl_empty_q: _fl_empty_q,
    _fl_has_key_q: _fl_has_key_q,
    _fl_print: _fl_print,
    _fl_array_q: _fl_array_q,
    _fl_request: _fl_request,
    _fl_response: _fl_response,
    _fl_wait_and_respond: _fl_wait_and_respond,
};
exports.default = exports.RUNTIME_HELPERS;
// ═══════════════════════════════════════════════════════
...
function make_array_block(items, line) { return make_block("Array", null, {  }, line); }
function make_map_block(items, line) { return make_block("Map", null, {  }, line); }
...
function make_pattern_list(items, _fl_rest, line) { return { kind: "pattern-list", rest: _fl_rest, line: line }; }
