...
exports.makeTemplateString = makeTemplateString;
...
exports.makePageNode = makePageNode;
exports.makeRouteNode = makeRouteNode;
exports.makeComponentNode = makeComponentNode;
exports.makeFormNode = makeFormNode;
...
function makeRouteNode(name, path, method, handler, middleware, validation, line) {
